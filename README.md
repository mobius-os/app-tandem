...
4. Tap any word: exact glossary entries highlight the true translated word in the other pane. If that occurrence has no glossary entry, Tandem shows only the aligned translated sentence—never a guessed word based on position. Tap the same word (or anywhere else) to clear. No bottom sheets.
